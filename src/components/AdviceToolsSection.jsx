...
const AdviceToolsSection = () => {
  const tools = [
    {
      title: "Rates & Trends",
      description: "Know all about Property Rates & Trends in Nagpur",
      icon: (
    ...
    },
    {
      ...
      description: "Discover the top localities in Nagpur for investment",
      icon: (
        <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Advice & Tools</h2>
          ...
          {tools.map((tool, index) => (
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <Link href={tool.link} className="text-blue-600 hover:text-blue-800 font-medium flex items-center">
                  View now
